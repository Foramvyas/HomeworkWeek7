...
// static method
        ...
        if (month < 1 || month > 12 || year < 1 || year > 9999) {
            ...
            switch (month) {
                ...
                case 2:
                    ...
                    if (isLeapYear(year)) {
                        System.out.println("February has 29 days  " + year + "  is Leap Year");
                        return 29;
                ...
                case 6:
                    ...
                    break;
                case 9:
                    System.out.println("Saptember has 30 days.");
                case 11:
    ...
    public static void main(String[] args) {
        NumberOfDaysInMonth.isLeapYear(-1800);                     // static methods calling via class name
        NumberOfDaysInMonth.getDaysInMonth(2, 2300);
    }
}
